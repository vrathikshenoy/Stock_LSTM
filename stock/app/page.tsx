  ...
  const features = [
    {
      ...
      description: "Advanced machine learning models to predict stock prices with high accuracy",
    },
    {
      icon: <BarChart2 className="h-6 w-6 text-purple-500" />,
      title: "Comprehensive Analytics",
      description: "Detailed metrics and visualizations to understand market trends",
    },
    {
      icon: <LineChart className="h-6 w-6 text-purple-500" />,
      title: "Historical Performance",
      description: "Compare predicted vs actual performance to validate model accuracy",
    },
  ]

  const testimonials = [
    {
      quote: "This tool has transformed how I approach stock investments. The predictions are remarkably accurate.",
      author: "Jane Cooper",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            >
              Predict Stock Prices with <span className="text-purple-600">Precision</span>
            </motion.h1>
            ...
            >
              Our AI-powered platform analyzes market trends and predicts future stock prices with remarkable accuracy,
              giving you the edge in your investment decisions.
            </motion.p>
            ...
            >
              ...
              <Button variant="outline" size="lg" className="px-8 py-6 rounded-lg font-medium text-lg">
                Learn More
              </Button>
            </motion.div>
          </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Trusted by Investors</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">See what our users have to say about our platform</p>
          </div>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-purple-100 mb-10 max-w-2xl mx-auto">
            Start making data-driven investment decisions today with our AI-powered stock prediction platform.
          </p>
          <Link href="/dashboard">
            <Button
              size="lg"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <div className="flex items-center">
                ...
                <span className="text-white text-xl font-bold">StockPredict</span>
              </div>
